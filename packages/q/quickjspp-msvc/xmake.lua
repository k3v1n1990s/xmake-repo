...
add_urls("https://github.com/k3v1n1990s/quickjspp.git")
add_versions("2022.05.09", "926a7258cb1c1c20ca5538f89c36fedd5a5868c7")
...
on_install(function(package)
    ...
    io.writefile("xmake.lua", [[
        ...
        option("jsx", {default = true})
        option("qjs", {default = true})
        option("qjsc", {default = true})
        option("storage", {default = true})
